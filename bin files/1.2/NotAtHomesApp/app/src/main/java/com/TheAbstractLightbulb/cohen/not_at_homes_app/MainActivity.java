    ...
    private void populateListView() {
        ...
        MainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                map = adapterView.getItemAtPosition(1).toString();
                name = adapterView.getItemAtPosition(2).toString();
                date = adapterView.getItemAtPosition(3).toString();
                notAtHomes = adapterView.getItemAtPosition(4).toString();
